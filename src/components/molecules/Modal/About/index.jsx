  ...
  return (
    <>
      <div className="flex flex-col align-center">
        ...
        <div className="my-6">
          <p>
            Lisse berbagi adalah wadah amal bagi penghuni Cluster Lisse (Perumahan Metland Cibitung) yang diselenggarai oleh Ibu-ibu PKK.<br/><br/>
            ...
            Dengan hadirnya aplikasi ini diharapkan semakin banyak donatur yang berpartisipasi dan pengelolaan yang transparan.
          </p>
